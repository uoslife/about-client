          ...
          <div className="flex flex-col items-start gap-10">
            <div className="flex h-[5.125rem] items-start gap-[5.875rem]">
              ...
              <div className="flex items-start gap-3 pt-0.5">
                <div className="flex items-center gap-3">
                  <p className="text-[#222227] text-xl font-medium leading-[160%]">
                    11월 24일(월)
                  </p>
                  <div className="w-10 h-0.5 bg-[#222227]"></div>
                </div>
                <div className="flex flex-col items-start gap-0.5">
                  <p className="text-[#222227] text-xl font-medium leading-[160%] self-stretch">
                    11월 30일(일)
                  </p>
                  <p className="text-[#222227] text-xl font-medium leading-[160%]">
                    오후 11시 59분 까지
            ...
            <div className="flex h-[5.125rem] items-start gap-[5.875rem]">
              ...
              <div className="flex flex-col items-start pt-0.5 gap-4">
                ...
                <p className="text-[#80808B] text-base font-medium leading-[160%]">
                  *면접 일정 및 장소는 추후 안내
                </p>
              </div>
            </div>
