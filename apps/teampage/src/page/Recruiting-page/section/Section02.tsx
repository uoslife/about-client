...
export function Section02() {
  return (
    <>
      <div className="flex items-start w-[100%] flex-row gap-[13.25rem] pb-60 px-80 pt-[100px] max-lg:flex-col max-lg:px-[16px] max-lg:gap-7 max-lg:w-[100%] max-lg:justify-center max-lg:pt-[80px] max-lg:pb-[120px]">
      ...
      <div className="flex flex-col items-center gap-10 text-center pb-40 max-lg:w-[100%] max-lg:px-[16px] max-lg:pb-[60px] max-lg:gap-[16px]">
