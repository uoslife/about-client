...
export function FAQbutton({ question, open, setOpen }: FAQbuttonProps) {
  return (
    ...
    max-md:py-1"
    >
      <h4 className="text-[#222227] text-[28px] font-bold leading-[150%] max-md:text-lg max-md:leading-[160%]">
        {question}
      </h4>
      <button
      ...
      >
        <div className="flex flex-col justify-center items-center w-6 h-6 gap-2.5 flex-shrink-0 max-md:w-[19.2px] max-md:h-[19.2px] max-md:gap-2">
