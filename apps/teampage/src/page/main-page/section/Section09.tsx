...
export function Section09() {
  ...
  return (
    <div
      className={twMerge(
        `bg-[url(/img/section09_bg.webp)] bg-right-bottom relative flex flex-col justify-center px-[180px] h-[600px] max-md:px-[18px]`, 
    ...
    >
      <div className="flex flex-col gap-9 items-start max-md:w-full max-md:h-full max-md:pt-8 max-md:justify-start max-md:p-9">
        ...
        >
          <Text variant="title-24-b" className='max-md:text-body-16-b'>모집 알림 받기</Text>
        </Link>
      </div>
    </div>
  );
