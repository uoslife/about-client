    ...
    >
      <div className="flex flex-col items-center text-center gap-9 max-md:px-[18px]">
        <div className="gap-4">
          ...
          <Text variant="title-48-b" className='max-md:text-title-24-b'>시대생이 쌓아가는 기술 이야기</Text>
        </div>
...
function TechArticleList() {
  ...
  return (
    <div className="px-[200px] grid grid-cols-2 gap-8 max-w-pc w-full max-md:grid-cols-1 max-md:justify-items-center max-md:px-[18px] max-md:gap-4">
      {techArticleContents
        .map((c) =>
